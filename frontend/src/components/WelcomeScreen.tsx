...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onStart }) => {
    return (
        <div className="h-screen w-full bg-vscode-bg flex flex-col items-center justify-center text-white relative overflow-hidden">
            {/* Background Decor */}
            ...
            >
                <div className="w-20 h-20 bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl flex items-center justify-center shadow-2xl shadow-blue-900/50 mb-8 border border-blue-400/20">
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={onStart}
                    className="group flex items-center gap-3 bg-blue-600 hover:bg-blue-500 text-white px-8 py-4 rounded-full font-medium text-lg transition-all shadow-lg shadow-blue-600/20"
                >
